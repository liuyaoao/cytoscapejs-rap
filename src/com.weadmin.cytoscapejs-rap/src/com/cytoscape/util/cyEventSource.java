...
public class cyEventSource
{
	...
	public interface cyIEventListener
	{
		 ...
		 */
		void invoke(Object sender, cyEventObject evt);
	 ...
	 */
	public cyEventSource(Object source)
	{
	 ...
	 */
	public void addListener(String eventName, cyIEventListener listener)
	{
	 ...
	 */
	public void removeListener(cyIEventListener listener)
	{
	 ...
	 * Removes all occurances of the given listener from the list of listeners.
	 */
	public void removeListener(cyIEventListener listener, String eventName)
	{
		if (eventListeners != null)
		{
	 ...
	 *
	 */
	public void fireEvent(cyEventObject evt)
	{
		fireEvent(evt, null);
	}
	 ...
	 */
	public void fireEvent(cyEventObject evt, Object sender)
	{
				...
				&& isEventsEnabled())
		{
			...
			for (int i = 0; i < eventListeners.size(); i += 2)
			{
				...
				{
					((cyIEventListener) eventListeners.get(i + 1)).invoke(
							sender, evt);
				}
			}
		}
