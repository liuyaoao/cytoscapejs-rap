...
public class cyEventObject
{
	 ...
	 */
	public cyEventObject(String name)
	{
	 ...
	 * <code>new cyEventObject("eventName", key1, val1, .., keyN, valN))</code>
	 */
	public cyEventObject(String name, Object... args)
	{
		this.name = name;
